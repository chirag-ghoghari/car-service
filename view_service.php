                ...
                <div class="container">
                    ...
                    <div class="table-responsive text-center">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $qry = "select * from service_request WHERE oname LIKE '$uname'";
;
                                // if (isset($_POST['asce'])) {
                                    ...
                                    <tr class="bg-danger">
                                        ...
                                        <td>
                                            <span class="badge <?php
                                                                switch ($r['status']) {
                                                                    case 0:
                                                                        echo 'bg-warning py-2';
                                                                        break;

                                                                    case 1:
                                                                        echo 'bg-success py-2';
                                                                        break;

                                                                    case 2:
                                                                        echo 'bg-primary py-2';
                                                                        break;
                                        ...
                                        <td>
                                            ...
                                            <a href="admin/delete-request.php?id=<?php echo $r['id'] ?>" class="btn btn-outline-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
